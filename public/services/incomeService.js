...
export async function getNormalizedIncomesAndOrders() {
  ...
  for (const d of normalDocs) {
    ...
    // Se esiste un documento manuale del giorno, manteniamo comunque gli incassi automatici legati agli ordini.
    // Filtriamo solo eventuali record manuali duplicati dello stesso giorno.
